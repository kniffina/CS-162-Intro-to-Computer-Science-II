/*************************************************************
* Filename: keyOfAThousandEchoes.hpp
* Email: kniffina@oregonstate.edu
* Author: Adam Kniffin
* Date: 3/14/2016
* Description: This is the hpp file for the class KeyOfAThousandEchoes
* It is inherited from the cave Item. It contains member variables,
* function declarations, and constructors.
***************************************************************/
#include "item.hpp"
#ifndef KEYOFATHOUSANDECHOES_HPP
#define KEYOFATHOUSANDECHOES_HPP

class KeyOfAThousandEchoes : public Item
{
private:
	//member variables
