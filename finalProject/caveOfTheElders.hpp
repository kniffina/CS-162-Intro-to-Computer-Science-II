/*************************************************************
* Filename: caveOfTheElders.hpp
* Email: kniffina@oregonstate.edu
* Author: Adam Kniffin
* Date: 3/7/2016
* Description: This is the hpp file for the class CaveOfTheElders.
* It is inherited from the cave class. It contains member variables,
* function declarations, and constructors.
***************************************************************/
#include "cave.hpp"
#ifndef CAVEOFTHEELDERS_HPP
#define CAVEOFTHEELDERS_HPP

class CaveOfTheElders : public Cave
{
private:
	//member variables
	string type;
