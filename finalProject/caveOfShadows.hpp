/*************************************************************
* Filename: caveOfShadows.hpp
* Email: kniffina@oregonstate.edu
* Author: Adam Kniffin
* Date: 3/12/2016
* Description: This is the hpp file for the class CaveOfShadows.
* It is inherited from the cave class. It contains member variables,
* function declarations, and constructors.
***************************************************************/
#include "cave.hpp"
#ifndef CAVEOFSHADOWS_HPP
#define CAVEOFSHADOWS_HPP

class CaveOfShadows : public Cave
{
private:
	//member variables
	string type;
