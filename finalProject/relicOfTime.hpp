/*************************************************************
* Filename: relicOfTime.hpp
* Email: kniffina@oregonstate.edu
* Author: Adam Kniffin
* Date: 3/14/2016
* Description: This is the hpp file for the class RelicOfTime
* It is inherited from the cave Item. It contains member variables,
* function declarations, and constructors.
***************************************************************/
#include "item.hpp"
#ifndef RELICOFTIME_HPP
#define RELICOFTIME_HPP

class RelicOfTime : public Item
{
private:
	//member variables
