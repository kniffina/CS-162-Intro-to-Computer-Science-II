/*************************************************************
* Filename: cavernOfTime.hpp
* Email: kniffina@oregonstate.edu
* Author: Adam Kniffin
* Date: 3/7/2016
* Description: This is the hpp file for the class CavernOfTime
* It is inherited from the cave class. It contains member variables,
* function declarations, and constructors.
***************************************************************/
#include "cave.hpp"
#ifndef CAVERNOFTIME_HPP
#define CAVERNOFTIME_HPP

class CavernOfTime : public Cave
{
private:
	//member variables
	string type;
