/*************************************************************
* Filename: prismOfInnerCalm.hpp
* Email: kniffina@oregonstate.edu
* Author: Adam Kniffin
* Date: 3/14/2016
* Description: This is the hpp file for the class PrismOfInnerCalm
* It is inherited from the cave Item. It contains member variables,
* function declarations, and constructors.
***************************************************************/
#include "item.hpp"
#ifndef PRISMOFINNERCALM_HPP
#define PRISMOFINNERCALM_HPP

class PrismOfInnerCalm : public Item
{
private:
	//member variables
