/*************************************************************
* Filename: shadowsEmbrace.hpp
* Email: kniffina@oregonstate.edu
* Author: Adam Kniffin
* Date: 3/14/2016
* Description: This is the hpp file for the class ShadowsEmbrace
* It is inherited from the cave Item. It contains member variables,
* function declarations, and constructors.
***************************************************************/
#include "item.hpp"
#ifndef SHADOWSEMBRACE_HPP
#define SHADOWSEMBRACE_HPP

class ShadowsEmbrace : public Item
{
private:
	//member variables
