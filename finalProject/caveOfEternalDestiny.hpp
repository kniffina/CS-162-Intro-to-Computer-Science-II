/*************************************************************
* Filename: caveOfEternalDesetiny.hpp
* Email: kniffina@oregonstate.edu
* Author: Adam Kniffin
* Date: 3/12/2016
* Description: This is the hpp file for the class CaveOfEternalDestiny
* It is inherited from the cave class. It contains member variables,
* function declarations, and constructors.
***************************************************************/
#include "cave.hpp"
#ifndef CAVEOFETERNALDESTINY_HPP
#define CAVEOFETERNALDESTINY_HPP

class CaveOfEternalDestiny : public Cave
{
private:
	//member variables
	string type;
